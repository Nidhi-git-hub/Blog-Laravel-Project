        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="{{URL('master')}}"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
                    <h3 class="menu-title">Profile</h3><!-- /.menu-title -->
                    <li>
                        <a href="{{URL('addprofile')}}"> <i class="menu-icon ti-email"></i>Add Profile</a>
                    </li>
                    <li>
                        <a href="{{URL('display')}}"> <i class="menu-icon ti-email"></i>Edit Profile</a>
                    </li>
                    
                    <h3 class="menu-title">Blogs</h3><!-- /.menu-title -->

                    <li>
                        <a href="{{URL('addBlogPost')}}"> <i class="menu-icon ti-email"></i>Add Blog</a>
                    </li>
                    <li>
                        <a href="{{URL('displayBlogPost')}}"> <i class="menu-icon ti-email"></i>View Blog</a>
                    </li>

                    <h3 class="menu-title">About</h3><!-- /.menu-title -->

                    <li>
                        <a href="{{URL('addabout')}}"> <i class="menu-icon ti-email"></i>Add About</a>
                    </li>
                    <li>
                        <a href="{{URL('displayabout')}}"> <i class="menu-icon ti-email"></i>View About</a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
